    ...
    if($check == true) {
        ...
        ?>
            ...
            <head>
                ...
                <style>
                /* CSS Cleanup */
                body {padding-top: 200px;padding-left: 200px;padding-right:200px;background-color: black;color: white;} div.b {word-wrap: break-word;color: red;}a {color: white;}a:hover {background-color: red;}a:visited {text-decoration: none;color: white;}
                </style>
            </head>
            <body>
                <center>
        ...
        if($connection->getLastHttpCode() != 200) {
            ...
            <head>
                ...
                <style>body {padding-top: 200px;padding-left: 200px;padding-right:200px;background-color: black;color: white;} div.b {word-wrap: break-word;color: red;}a {color: white;}a:hover {background-color: red;}a:visited {text-decoration: none;color: white;}
            </style>
            </head>
            <body>
                <center>
                    <!-- Recovery -->
                    <p>An unrecoverable error has occured.<br>If you're a regular user, please DM me on <a href="https://twitter.com:443/">Twitter</a> with the following error code:<br>
                    <div class="b">ERROR NO. <?php echo base64_encode($result->errors[0]->message);?></div><br><br>
            ...
            <head>
                <title>tweet</title>
                <style>body {;padding-top: 200px;padding-left: 200px;padding-right:200px;background-color: black;color: white;}div.a {color: #32CD32}a {color: white;}a:hover {background-color: red;}a:visited {text-decoration: none;color: white;}
            </style>
            </head>
            <body>
            <center>
